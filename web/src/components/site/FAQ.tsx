  ...
  return (
    <Accordion type="single" collapsible className="measure border-t border-line">
      {faqs.map((faq, i) => (
        ...
        >
          <AccordionTrigger className="min-h-12 py-4 font-display text-[1.0625rem] leading-[1.4] font-semibold text-ink no-underline hover:no-underline **:data-[slot=accordion-trigger-icon]:mt-1 **:data-[slot=accordion-trigger-icon]:text-aqua-500">
            {renderText(faq.q)}
          </AccordionTrigger>
