...
/** Inline "Read the case →" style link on a light ground. */
export const linkArrow = `inline-flex items-center gap-1.5 text-sm font-semibold text-orange-600 transition-colors duration-150 hover:text-orange-500 ${focusRing}`;

/** Same, on a navy band. */
export const linkArrowBand = `inline-flex items-center gap-1.5 text-[0.9375rem] font-semibold text-orange-500 transition-colors duration-150 hover:text-white ${focusRing}`;
